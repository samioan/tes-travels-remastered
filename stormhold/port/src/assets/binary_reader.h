...
// Reads Stormhold's on-disk data tables, which are Java DataInputStream
...
// NUL/surrogate encodings). Identical to dawnstar's own BinaryReader --
// same "ngame" engine, same DataInputStream-based table format.
class BinaryReader {
public:
