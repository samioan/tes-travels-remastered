...
// MsgWaitForMultipleObjects). Same two real differences from
// shadowkey-decomp dawnstar's own version already carries over: there is
// no font row (Stormhold's renderer draws its own embedded bitmap font --
// see graphics/bitmap_font.h/.cpp -- and reads no external file), and
// "Choose file..." asks for a single .jar rather than a folder to search
// (see launcher/install.h).
//
