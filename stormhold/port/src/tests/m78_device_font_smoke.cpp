// M78 smoke test: assets/gdr_font.h (the Symbian .gdr parser) and
...
//
// Usage: m78_device_font_smoke [fontDir] [out.ppm]
...
int main(int argc, char** argv) {
    ...
    if (!g_ok) {
        std::fprintf(stderr, "m78_device_font_smoke: FAILED self-consistency checks\n");
        return 1;
    }
